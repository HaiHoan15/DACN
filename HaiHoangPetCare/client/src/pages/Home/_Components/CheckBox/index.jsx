          ...
          <div className="absolute right-0 mt-3 z-50">
            <div className="max-w-xs w-64 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.08),0_15px_15px_-6px_rgba(0,0,0,0.06)] transition-all duration-300">
              ...
              <div className="py-1.5">
                ...
                {/* Thú cưng */}
                <NavLink
                  to={user?.Fullname ? `/nguoi-dung/${user.Fullname}?tab=pet` : "/nguoi-dung?tab=pet"}
                  className="group relative flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 transition-all duration-200"
                >
                  <div className="w-8 h-8 rounded-lg bg-green-100 flex items-center justify-center mr-3 group-hover:bg-green-200 transition-colors duration-200">
                    <i className="fa-solid fa-paw text-green-600"></i>
                  </div>
                  <span className="font-medium text-gray-700 group-hover:text-green-700">Thú cưng</span>
                </NavLink>

                {/* Lịch khám */}
                <NavLink
                  to={user?.Fullname ? `/nguoi-dung/${user.Fullname}?tab=schedule` : "/nguoi-dung?tab=schedule"}
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-yellow-100 flex items-center justify-center mr-3 group-hover:bg-yellow-200 transition-colors duration-200">
                    <i className="fa-regular fa-calendar-check text-yellow-600"></i>
                  </div>
                  <span className="font-medium text-gray-700 group-hover:text-yellow-700">Lịch khám</span>
                </NavLink>

                {/* Giỏ hàng */}
                <NavLink
                  to={user?.Fullname ? `/nguoi-dung/${user.Fullname}?tab=wishlist` : "/nguoi-dung?tab=wishlist"}
                  className="group relative flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 transition-all duration-200"
                >
                  <div className="w-8 h-8 rounded-lg bg-purple-100 flex items-center justify-center mr-3 group-hover:bg-purple-200 transition-colors duration-200">
                    <i className="fa-solid fa-cart-shopping text-purple-600"></i>
                  </div>
                  <span className="font-medium text-gray-700 group-hover:text-purple-700">Giỏ hàng</span>
                </NavLink>

                {/* Đơn hàng */}
                <NavLink
                  to={user?.Fullname ? `/nguoi-dung/${user.Fullname}?tab=order` : "/nguoi-dung?tab=order"}
                  className="group relative flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 transition-all duration-200"
                >
                  <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center mr-3 group-hover:bg-blue-200 transition-colors duration-200">
                    <i className="fa-solid fa-box-open text-blue-600"></i>
                  </div>
                  <span className="font-medium text-gray-700 group-hover:text-blue-700">Đơn hàng</span>
                </NavLink>
