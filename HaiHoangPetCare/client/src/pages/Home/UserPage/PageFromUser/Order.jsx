      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div key={order.Order_ID} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4 pb-4 border-b">
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">Đơn hàng #{order.Order_ID}</h3>
        ...
        {showModal && selectedOrder && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-height-[90vh] overflow-y-auto">
