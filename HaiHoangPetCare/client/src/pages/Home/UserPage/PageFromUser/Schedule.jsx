...
import BookAppointment from "./ScheduleComponents/BookAppointment";
...
export default function Schedule() {
  ...
  }, [userId, currentWeek, dateFilter, statusFilter]);
  ...
  const handleBookSuccess = () => {
    // Refresh data sau khi đặt lịch thành công
    fetchScheduleData();
    fetchAppointments();
  };
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-lg font-semibold shadow-lg transition-all flex items-center gap-2"
            >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 font-medium bg-white"
                >
