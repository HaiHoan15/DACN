    ...
    >
      ...
      <div className="text-center mb-14" data-aos="fade-down">
        ...
        <p className="mt-3 text-lg text-gray-800 max-w-2xl mx-auto">
          ...
          là nền tảng chăm sóc thú cưng toàn diện, giúp bạn dễ dàng quản lý hồ
          sơ, đặt lịch khám và trò chuyện cùng AI để chăm sóc thú cưng hiệu quả
          hơn bao giờ hết.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
        ...
        {/* Nội dung bên phải */}
        <div
          className="md:w-1/2 bg-blue-50 p-8 rounded-2xl shadow-md"
          data-aos="fade-right"
        >
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        {/* Nội dung bên trái */}
        <div
          className="md:w-1/2 bg-orange-50 p-8 rounded-2xl shadow-md"
          data-aos="fade-left"
        >
          ...
          <ul className="space-y-2 text-gray-800">
            <li>
              <strong className="text-orange-600">Yêu thương:</strong>&nbsp;Xem
              thú cưng như người bạn thân thiết, không chỉ là vật nuôi.
            </li>
            <li>
              <strong className="text-orange-600">Đồng hành:</strong>&nbsp;Luôn
              lắng nghe và hỗ trợ người nuôi thú cưng mọi lúc.
            </li>
            <li>
              <strong className="text-orange-600">Trí tuệ nhân tạo:</strong>
              &nbsp;Ứng dụng AI để gợi ý và theo dõi sức khỏe thú cưng chính
              xác hơn.
            </li>
            <li>
              <strong className="text-orange-600">Tiện ích:</strong>&nbsp;Tất
              cả dịch vụ chăm sóc trong một nền tảng duy nhất.
            </li>
          </ul>
        </div>
