            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gradient-to-r from-blue-600 to-purple-600">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase">Loại thanh toán</th>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition text-sm font-medium flex items-center gap-1"
                          >
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {/* Thanh toán  */}
                    <div>
                      <p className="text-sm text-gray-500">Loại thanh toán</p>
                      <p className="font-medium">
                        {selectedOrder.PaymentMethod === "VNPAY" ? "VNPAY" : "COD"}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {["pending", "confirmed", "shipping", "delivered", "cancelled"].map((status) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${selectedOrder.Status === status
