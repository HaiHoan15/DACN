...
export default function ScheduleManagement() {
  ...
  const tabs = [
    { id: "calendar", label: "Lịch khám" },
    { id: "appointments", label: "Danh sách lịch" },
  ];
  ...
  useEffect(() => {
    fetchAppointments();
  }, [selectedBranch, selectedRoom, selectedDoctor, searchDate, dateFilter, statusFilter]);
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        {/* PHẦN 2: BÁC SĨ – CHI NHÁNH – PHÒNG */}
        <div className="bg-white rounded-xl shadow-md p-6 mb-4 space-y-4">
          <DoctorTab
            doctors={doctors}
                ...
                <div className="flex gap-2">
                  {["all", "today", "upcoming", "past"].map((f) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${dateFilter === f
