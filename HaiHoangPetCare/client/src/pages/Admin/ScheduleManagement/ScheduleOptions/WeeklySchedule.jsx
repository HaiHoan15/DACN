          ...
          <tbody>
            ...
            {periods.slice(0, 8).map((period) => (
              <tr key={`morning-${period}`} className="hover:bg-gray-50">
                <td className="border border-gray-300 px-3 py-2 text-center font-semibold bg-blue-100">
                  Tiết {period}
                </td>
                {daysOfWeek.map((day) => {
                    ...
                    >
                      {schedule ? (
                        <div className="font-medium text-[10px] leading-tight space-y-0.5">
                          ...
                          {/* {schedule.PeriodEnd > schedule.Period && (
                            <div className="text-orange-600 text-[9px] font-bold">
                              {schedule.Period}-{schedule.PeriodEnd}
                            </div>
                          )} */}
                        </div>
                      ) : (
