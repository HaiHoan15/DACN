...
import { periodRangeToTime, getStatusLabel, getStatusColor } from "../../../Home/UserPage/PageFromUser/ScheduleComponents/timeUtils";
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gradient-to-r from-blue-600 to-blue-600">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-xs font-bold text-white uppercase">Giờ khám</th>
              ...
              paginatedAppointments.map((apt) => (
                <tr key={apt.Appointment_ID} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold">
                    {periodRangeToTime(apt.Period, apt.PeriodEnd)}
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-3 py-1 text-xs font-semibold rounded-full border-2 ${getStatusColor(apt.Status)}`}>
